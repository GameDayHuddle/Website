...
export const metadata: Metadata = { title: "Contact | GameDay Huddle", description: "Talk to us about an organization plan for a youth football club or league, or ask anything about GameDay Huddle." };
  ...
  return <div className="marketing-page"><MarketingHeader /><main>
    ...
    <section className="contact-section section-shell">
      <div className="contact-aside">
        ...
        <p>The Organization plan covers every team in a youth club or league for a year. We set those up directly rather than through checkout, so we can get the teams and the coaches arranged with you. <a href="/pricing">See what the plans cover</a>.</p>

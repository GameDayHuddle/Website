...
export default function LoginPage() {
  return (
    <main className="login-page">
      <div className="login-brand"><Brand /><a href="/">Back to website</a></div>
      ...
      <section className="login-form-side"><DemoLogin /><p className="login-legal">By continuing, you agree to the <a href="/terms">Terms</a> and <a href="/privacy">Privacy Policy</a>.</p></section>
    </main>
  );
}

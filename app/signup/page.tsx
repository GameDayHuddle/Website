...
export default function SignupPage() {
  return <div className="marketing-page"><MarketingHeader /><main>
    <section className="subpage-hero section-shell"><p className="section-kicker">Create your account</p><h1>Two ways to run <em>your program.</em></h1><p>A coach signs up here and starts right away. A club, league, or school system gets its plan set up with us, so every team lands under one subscription.</p></section>
